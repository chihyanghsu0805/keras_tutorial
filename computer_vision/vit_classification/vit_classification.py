# This code follows the tutorial on
...
def main(args):
    ...
    plot_patches(x_train, image_size, patch_size, args.output_dir)

    vit_classifier = create_vit_classifier(
        input_shape, patch_size, num_patches, projection_dim,
        transformer_layers, num_heads, transformer_units,
        mlp_head_units, num_classes, data_augmentation
    )

    model_plot = os.path.join(args.output_dir, "./vit_classifier.png")

    keras.utils.plot_model(
        vit_classifier, to_file=model_plot,
...
def plot_patches(x_train, image_size, patch_size, output_dir):
    ...
    fig.savefig(
        os.path.join(output_dir, "./vit_classification_patches.jpeg")
    )
