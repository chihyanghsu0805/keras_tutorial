...
def main(args):
    ...
    copyfile(img_path, os.path.join(args.output_dir, "elephant.jpg"))
    ...
    igrads = random_baseline_integrated_gradients(
        model, img_size, np.copy(orig_img), top_pred_idx=top_pred_idx, num_steps=50, num_runs=2
    )
    ...
    vis.visualize(
        ...
        output_file = os.path.join(args.output_dir, "integrated_gradients_0_99.jpg")
    )
    ...
    vis.visualize(
        ...
        outlines=True,
        output_file = os.path.join(args.output_dir, "integrated_gradients_28_95.jpg")
    )
...
def random_baseline_integrated_gradients(model, img_size, img_input, top_pred_idx, num_steps=50, num_runs=2):
